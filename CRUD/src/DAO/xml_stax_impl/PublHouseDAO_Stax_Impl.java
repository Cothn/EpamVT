...
import DAO.xml_stax_impl.serializers.PublHouseStaxParser;
...
public class PublHouseDAO_Stax_Impl implements PublishingHouseDAO {
    ...
    public List<PublishingHouse> getAll() throws DaoException {
        ...
        try {
            ...
            publHouses = PublHouseStaxParser.parse(reader);
        }catch (Exception e) {
