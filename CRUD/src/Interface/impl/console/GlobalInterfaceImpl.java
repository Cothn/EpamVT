...
public class GlobalInterfaceImpl {
    ...
    public void Show() {
        ...
        while (!FExit) {
            ...
            System.out.println("7. Migration");
    ...
    /**
     * Выводит на консоль интерфейс миграции
     */
    private void ShowMigrationInterface()
    {
        try {
            ...
            while (!exitFlag) {
                ...
                switch (res) {
                    ...
                    case "2": {
                        System.out.println("Enter xsd name:");
                        String xsdPath = GlobalConstant.SourceFilePath+scanner.nextLine();
                        System.out.println("Enter xml name:");
                        String xmlPath = GlobalConstant.SourceFilePath+scanner.nextLine();
