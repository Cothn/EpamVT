...
public class LibraryServiceImpl implements LibraryService {
     ...
     */
    @Override
    public List<LibraryObj> getAllLibraryObj() throws ServiceException{
        try {
     ...
     */
    @Override
    public List<LibraryObj> sortByTitle(boolean ascending) throws ServiceException
    {
        try {
     ...
     */
    @Override
    public List<LibraryObj> findByAuthor(int authorId) throws ServiceException{
        try {
            ArrayList<LibraryObj> allLibraryObj = (ArrayList<LibraryObj>) DAOFactory.getLibraryDAO().getAll();
     ...
     */
    @Override
    public List<LibraryObj> findByPublishingHouse(int publishingHouseId) throws ServiceException {
        try {
            ArrayList<LibraryObj> allLibraryObj = (ArrayList<LibraryObj>) DAOFactory.getLibraryDAO().getAll();
            ArrayList<LibraryObj> findLibraryObj = new ArrayList<>();
            for (LibraryObj libraryObj : allLibraryObj) {
